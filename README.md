...
● Entered behaviours are automatically capitalized. For behaviours to be valid, they must be seperated by whitespaces (this does not apply to the punctuation).
