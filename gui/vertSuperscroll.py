...
class Scrolling_Area(Frame, object):
    ...
    def __init__(self, master, width=None, anchor=N, height=None, mousewheel_speed = 2, scroll_horizontally=True, scroll_vertically=True, yscrollbar=None, background=None, inner_frame=Frame, **kw):
